...
export default function CropPage() {
    ...
    const checkBatchCompletion = async (totalJobs: number) => {
        ...
        if (completedCount.current === totalJobs && totalJobs > 1) {
            ...
            try {
                ...
                a.href = url;
                a.download = "Fichiers_Rognes.zip";
                a.click();
                ...
                if (data.status === 'done') {
                    ...
                    if (totalJobs === 1) {
                        ...
                        try {
                            ...
                            zipRef.current.file(`${baseName}-rogne.${ext}`, blob);
                        } catch (err) {
    ...
    return (
        ...
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 space-y-4 flex flex-col gap-2">
                ...
                <div className="flex justify-end pt-4 border-t border-gray-50">
                    <button onClick={handleProcessAll} disabled={isProcessing || jobs.filter(j => j.status === 'idle').length === 0} className="w-full md:w-auto bg-black text-white px-6 py-2.5 rounded-lg font-medium transition-all hover:bg-gray-800 disabled:bg-gray-300">
